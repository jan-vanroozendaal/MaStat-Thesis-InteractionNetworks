#subset by Model 3, edges all appear within cluster
...
#filter by path type Z-Z
df_total <- df_total[df_total$path_type == "Z to Z",]
...
for (i in 1:length(models)) {
  ...
  #create file name
  plot_name <- paste(models[i], "ZZ_Condensed.jpg", sep = "")
