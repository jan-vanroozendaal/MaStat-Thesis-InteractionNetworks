...
#subset on Model
df_weight_model <- merge(x=df_nonprogrammed_total[df_nonprogrammed_total$model == "Model 3"
...
for (i in 1:length(thresholds)) {
  #create file name
  plot_name <- paste(paste(i,"_Model3_NonProgrammedEdgeCat_", sep=""), paste(thresholds[i], ".jpg", sep=""), sep="")
